package com.lwx.my.shop.web.ui.controller;

import com.lwx.my.shop.commons.dto.BaseResult;
import com.lwx.my.shop.commons.utils.EmailSendUtils;
import com.lwx.my.shop.web.ui.api.UsersApi;
import com.lwx.my.shop.web.ui.constant.SystemConstants;
import com.lwx.my.shop.web.ui.dto.TbUser;
...
public class LoginController {
    ...
    public String login(TbUser tbUser, Model model, HttpServletRequest request) throws Exception {
        ...
        // 登录成功
            ...
            emailSendUtils.send("用户登录", String.format("用户 【%s】 登录 MyShop", user.getUsername()), "刘武祥@yeah.net");
            // 将会员信息放入 Session
